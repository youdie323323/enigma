...
import { IR, IRNumericalData, IRLabel, IROpcode, IRReference, IRStringData, labelSymbol, referenceSymbol, opcodeSymbol, stringDataSymbol, numericalDataSymbol } from './CompilerIntermediateRepresentation';
